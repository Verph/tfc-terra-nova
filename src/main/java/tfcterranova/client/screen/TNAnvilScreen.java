...
import tfcterranova.common.container.TNAnvilContainer;

public class TNAnvilScreen extends BlockEntityScreen<TerraNovaAnvilBlockEntity, TNAnvilContainer>
{
    public static final ResourceLocation BACKGROUND = Helpers.identifier("textures/gui/anvil.png");

    public TNAnvilScreen(TNAnvilContainer container, Inventory playerInventory, Component name)
    {
