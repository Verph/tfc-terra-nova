...
val modVersion: String = System.getenv("VERSION") ?: "1.0"

val modId: String = "tfcterranova"

base {
    archivesName.set("TFCTerraNova-$minecraftVersion")
    group = "tfcterranova"
    version = modVersion
}
...
mixin {
    add(sourceSets.main.get(), "tfcterranova.refmap.json")
}
