...
public class SandLayerBlock extends TFCSandBlock implements IFluidLoggable, IForgeBlockExtension
{
   ...
   public void placeSandPile(LevelAccessor level, BlockPos pos, BlockState state, boolean byPlayer)
   {
      ...
      {
         level.getBlockEntity(pos, TerraNovaBlockEntities.SAND_PILE.get()).ifPresent(entity -> entity.setHiddenStates(state, savedAboveState, byPlayer));
      }
